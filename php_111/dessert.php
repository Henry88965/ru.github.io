            ...
            <div class = "product_area X1">
                <div class="product_card ">
                    <?php
                        ...
                        ?>
                    <button onclick="addcart('馬卡龍1')">加入購物車</button>
                </div>
                <div class="product_card">
                    <?php
                            include("member_connect.php");
                        ...
                        ?>
                    <button onclick="addcart('馬卡龍2')">加入購物車</button>
                </div>
                <div class="product_card">
                    <?php
                            include("member_connect.php");
                        ...
                        ?>
                    <button onclick="addcart('馬卡龍3')">加入購物車</button>
                </div>
                 <div class="product_card">
                    <?php
                            include("member_connect.php");
                        ...
                        ?>
                    <button onclick="addcart('馬卡龍4')">加入購物車</button>
                </div>
                <div class="product_card">
                    <?php
                            include("member_connect.php");
                        ...
                        ?>
                    <button onclick="addcart('馬卡龍5')">加入購物車</button>
                </div>
            </div>
