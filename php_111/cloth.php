            ...
            <div class="item_area">
                ...
                <div class = "product_area X1">
                    ...
                    <div class="product_card">
                        ...
                        ?>
                        <button onclick="addcart('衣服2')">加入購物車</button>
                    </div>
                    <div class="product_card">
                        <?php
                            include("member_connect.php");
                        ...
                        ?>
                        <button onclick="addcart('衣服3')">加入購物車</button>
                    </div>
                     <div class="product_card">
                        <?php
                            include("member_connect.php");
                        ...
                        ?>
                        <button onclick="addcart('衣服4')">加入購物車</button>
                    </div>
                    <div class="product_card">
                        <?php
                            include("member_connect.php");
                        ...
                        ?>
                        <button onclick="addcart('衣服5')">加入購物車</button>
                    </div>
                </div>
